...
directly measured to reduce in mean (within-query capped-versus-uncapped
contrast $-0.029$, block bootstrap $95\%$ CI $[-0.053,-0.010]$). On the upper-bound tiers the capped design's
...
deterministic decision rule --- a different estimand). First block: the
main analysis --- randomized-boundary repeated cross-fit at the common
target $0.02513$ ($R = 200$ half-splits; training-half size exact,
...
Second block: full-batch deterministic-threshold interpolation to
...
\begin{tabular}{lcccc}
\hline
\multicolumn{5}{l}{\emph{Randomized-boundary repeated cross-fit, common
target $0.02513$ (final design vs calibrated no borrowing):}}\\
\multicolumn{5}{l}{corpus mixing $+0.0025$ $[+0.0018,+0.0032]$,
$200/200$ splits $>0$, eval.\ sizes $0.02514/0.02514$ (at target
$0.025$: $+0.0025$);}\\
\multicolumn{5}{l}{$N(0,1)$: $+0.0128$ $[+0.0122,+0.0136]$;
$N(0,0.5)$: $+0.0397$ $[+0.0383,+0.0407]$; location-held
$N(+0.124,1)$: $+0.0117$; $N(+0.124,0.5)$: $+0.0362$}\\
\hline
Design & $\tau$ (matched) & Achieved size & Power & $\Delta$ vs no borrow
(se) \\
\hline
\multicolumn{5}{l}{\emph{Full-batch deterministic-threshold
...
\href{https://doi.org/}{DOI: to be assigned upon acceptance (Zenodo
deposit of the tagged release)}; the archive includes the per-round
