...
def f13():
    ...
    ax.set_title("Primary analysis: capped not detectably different from EB,\n"
                 "uncapped harmful (post hoc exploratory redesign comparison;\n"
...
def f14():
    ...
    axs[0].text(-1.48, 0.051, "tolerated ceiling 0.05", fontsize=7.5,
                color=BAD, va="bottom")
